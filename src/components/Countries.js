          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-8">
            ...
            >
              <input
                ...
                className="w-80 py-3 px-4 text-gray-600 placeholder-gray-600  shadow rounded outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-800 dark:focus:bg-gray-700 transition-all duration-200"
              />
            </form>
